...
a{color:#666;}
#table{margin:0 auto;background:#333;box-shadow: 10px 10px 10px #888888;border-radius:20px;color:#CCC;padding:20px;}
#table1{margin:10 auto;}
</style>
<body background="4.jpeg">
<button  id="myButton"  name="back"><a href="homeadmin.php" >BACK</a></button> 
<h1><p align="center">UPLOAD PROJECT</p></h1> 
...
<tr>
<th colspan="2" scope="row"><input type="submit" name="submit" id="submit" value="Upload" /></th>
</tr>
</table>
</form>
<br />
